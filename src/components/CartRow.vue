  ...
  <tr>
    ...
    <td>
        <div class="d-flex align-items-center justify-content-center">
            <button @click.prevent="decrementQty" class="btn btn-outline-secondary mr-4"><i class='fas fa-minus'></i></button>
            <p style="text-align: center;">{{qty}}</p>
            <button @click.prevent="incrementQty" class="btn btn-outline-secondary ml-4"><i class='fas fa-plus'></i></button>
        </div>
    </td>
    <td>{{total}}</td>
...
export default {
  ...
  methods: {
    ...mapMutations(['REMOVE_CART', 'EDIT_CART']),
    remove () {
