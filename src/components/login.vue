			...
			<div class="card-body">
				<form>
					...
					<div class="form-group">
						<input type="submit" value="Login" class="btn login_btn" @click.prevent="loginUser">
					</div>
				</form>
                    <div class="form-group">
						<button class="btn cancel_btn" @click.prevent="cancelLogin">Cancel</button>
					</div>
			</div>
			<div class="card-footer">
				<div class="d-flex justify-content-center links">
					Don't have an account?<a href="#" @click.prevent="register">Register</a>
				</div>
			</div>
		</div>
	</div>
