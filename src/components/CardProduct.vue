            ...
            <div class="category mb-10">
                ...
                <div class="frhoverinfo">
                    <!-- <ul class="productaction">
                        <li><a  @click.prevent="setQuantity(product.id)"><i class="fa fa-shopping-bag"></i></a></li>
                        <li><a @click.prevent="toCart(product.id, product.price, product.stock)"><i class="fa fa-plus"></i> {{quantity}}</a></li>
